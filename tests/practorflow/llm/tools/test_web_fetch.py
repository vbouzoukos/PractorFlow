...
class TestWebFetchTool:
    ...
    def test_execute_missing_url_and_invalid_scheme(self):
        tool = WebFetchTool()
    ...
    def test_execute_http_error_status(self, monkeypatch):
        tool = WebFetchTool()
    ...
    def test_execute_unsupported_content_type(self, monkeypatch):
        tool = WebFetchTool()
    ...
    def test_execute_raw_mode_with_truncation(self, monkeypatch):
        ...
        result = tool.execute(url="https://example.com", extract_mode="raw")
    ...
    def test_execute_metadata_mode_full_coverage(self, monkeypatch):
        tool = WebFetchTool()
    ...
    def test_execute_text_mode_with_title_and_truncation(self, monkeypatch):
    ...
    def test_execute_exception_path(self, monkeypatch):
        tool = WebFetchTool()
    ...
    def test_extract_metadata_description_fallback_pattern(self, monkeypatch):
        tool = WebFetchTool()
    ...
    def test_extract_metadata_links_limit_break(self, monkeypatch):
        tool = WebFetchTool()
    ...
    def test_extract_metadata_headings_limit_break(self, monkeypatch):
        tool = WebFetchTool()
